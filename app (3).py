...
@st.cache_data
def load_data():
    # CSV 파일 경로: 여러 경우를 순서대로 시도
    candidates = [
        "seoul_dessert_spots.csv",                                          # 현재 작업 디렉토리
        os.path.join(os.path.dirname(os.path.abspath(__file__)), "seoul_dessert_spots.csv"),  # 앱 파일 기준
        os.path.join(os.getcwd(), "seoul_dessert_spots.csv"),               # cwd 기준
    ]
    ...
    if csv_path:
        ...
        st.error(
            "⚠️ `seoul_dessert_spots.csv` 파일을 찾을 수 없습니다. "
